              ...
              <div class="card p-4">
                  <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                    <button class="btn btn-secondary"> 
                      <img src="<?php echo $arr['Photo']?>" height="100" width="100" />
                    </button> 
                      <span class="name mt-3"><?php echo $arr['Username']; ?></span> 
                      <span class="idd"><?php echo $arr['Role']; ?></span>  
                      <div class="text mt-3"> 
                        <span><b>Department:</b> <?php echo $arr['DepartmentName'] ?></span><br>
                        <span><b>Email:</b> <?php echo $arr['Email'] ?></span><br>
                        <span><b>Phone:</b> <?php echo $arr['Phone'] ?></span><br>
                        <span><b>Address:</b> <?php echo $arr['Address'] ?></span>
                      </div><br>
                      <div class=" d-flex mt-2"> 
                        <a href="account-edit.php?UserID=<?php echo $user; ?>"><button class="btn1 btn-primary">Edit Account</button> </a>
                      </div>
                  </div>
              </div>
          </div>
