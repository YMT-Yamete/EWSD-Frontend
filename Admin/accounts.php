    ...
    <div class="wrapper d-flex align-items-stretch">
      <nav id="sidebar">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
          <h2 style="text-align: center;"><b>User Accounts</b></h2>
          <a href="account-add.php"><button type="button" class="btn btn-primary">Add account + </button></a>
          <table>
            <tr><td></td></tr>
            <tr><td></td></tr>
          </table>
            <table id="myTable" class="table table-striped table-bordered" width="100%">
              ...
              <tbody>
                <?php 
                $select="Select * from users u,departments d 
                ...
                for ($i=0; $i <$count ; $i++) { 
                  ...
                  $User=$arr['UserID'];
                    echo "<tr>";
                        ...
                        echo "<td><a href='account-view.php?UserID=$User'>View Detail</a></td>";  
